...
def wait_for_sync(plan, l1_config_env_vars):
    plan.print("wait-for-l1-sync l1_config_env_vars: ")
    plan.print(l1_config_env_vars)
    plan.run_sh(
        ...
        run='while true; do sleep 5; \
            ...
            is_optimistic=false; \
            echo "is_optimistic=$is_optimistic"; \
